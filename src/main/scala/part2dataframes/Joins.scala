...
object Joins extends App {
	...
	// inner joins
	val joinCondition = guitaristsDF.col("band") === bandsDF.col("id") // extract condition to variable
	...
	// NOTE THAT spark doesn't automatically drop one of the joinCondition column.
